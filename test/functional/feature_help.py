...
"""Verify that starting grailum with -h works as expected."""

from test_framework.test_framework import GrailumTestFramework
from test_framework.util import assert_equal

class HelpTest(GrailumTestFramework):
    ...
    def run_test(self):
        self.log.info("Start grailum with -h for help text")
        ...
        self.log.info("Start grailum with -version for version information")
        ...
        self.log.info("Start grailumd with -fakearg to make sure it does not start")
