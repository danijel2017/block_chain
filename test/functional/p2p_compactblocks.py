...
# TestP2PConn: A peer we use to send messages to grailumd, and store responses.
...
class CompactBlocksTest(GrailumTestFramework):
    ...
    # This test actually causes grailumd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that grailumd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for grailumd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # grailumd will not send blocktxn responses for blocks whose height is
