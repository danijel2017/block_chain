Grailum Core version 0.13.2 is now available from:

  <https://grailum.org/bin/grailum-core-0.13.2/>
...
- #8908 `4a974b2` Update grailum-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow grailum-tx to create v2 transactions (GXMdrak)
