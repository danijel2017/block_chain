Grailum Core version *0.15.2* is now available from:

  <https://grailumcore.org/bin/grailum-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in grailum-tx (TheBlueMatt)
