Grailum Core version 0.10.4 is now available from:

  <https://grailum.org/bin/grailum-core-0.10.4/>
...
- #6953 `43c2789` Split grailum-tx into its own package
- #6953 `dfe0d4d` Include grailum-tx binary on Debian/Ubuntu
