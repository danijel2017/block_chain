Grailum Core version 0.16.1 is now available from:

  <https://grailumcore.org/bin/grailum-core-0.16.1/>
...
- #12843 `df38b13` Test starting grailumd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure grailumd processes are cleaned up when tests end (sdaftuar)
