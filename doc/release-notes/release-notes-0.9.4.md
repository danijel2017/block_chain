Grailum Core version 0.9.4 is now available from:

  https://grailum.org/bin/0.9.4/
...
this update is incompatible with the Grailum system and could lead to consensus
forks.

Grailum Core released binaries from https://grailum.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~grailum/+archive/ubuntu/grailum
- A third-party or self-compiled Grailum Core

upgrade to Grailum Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
