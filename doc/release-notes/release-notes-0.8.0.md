Grailum-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/grailum/files/Grailum/grailum-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Grailum
...
New/changed settings (command-line or grailum.conf file)
--------------------------------------------------------
