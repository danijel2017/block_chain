Grailum Core version 0.16.3 is now available from:

  <https://grailumcore.org/bin/grailum-core-0.16.3/>
...
been discovered in Grailum Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` grailumconsensus: invalid flags error should be set to `grailumconsensus_err` (afk11)
