Grailum Core version 0.9.2.1 is now available from:

  https://grailum.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 GXM to 0.01 GXM
...
- Fix "Start grailum on system login"
