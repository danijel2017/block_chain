Download URL: https://sourceforge.net/projects/grailum/files/Grailum/grailum-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 GXM fee schedule (users still pay 0.01 GXM per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #grailum00 - #grailum99
