Grailum Core version 0.14.2 is now available from:

  <https://grailum.org/bin/grailum-core-0.14.2/>
...
(in Grailum Core 0.10.3) it has been disabled by default.
...
- #10228 `ae479bc` Regenerate grailum-config.h as necessary (theuni)
