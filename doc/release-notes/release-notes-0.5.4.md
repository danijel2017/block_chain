Grailum version 0.5.4 is now available for download at:
http://sourceforge.net/projects/grailum/files/Grailum/grailum-0.5.4/
...
http://gitorious.org/grailum/grailumd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Grailum-Qt notifications under Growl 1.3.
Increase required age of Grailum-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxGrailum properly when installing Grailum-Qt over it. (Windows)
