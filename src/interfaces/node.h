...
#ifndef GRAILUM_INTERFACES_NODE_H
#define GRAILUM_INTERFACES_NODE_H
...
//! Top-level interface for a grailum node (grailumd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // GRAILUM_INTERFACES_NODE_H
