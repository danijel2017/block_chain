 ...
 */
#ifndef GRAILUM_UTIL_H
#define GRAILUM_UTIL_H
...
extern const char * const GRAILUM_CONF_FILENAME;
extern const char * const GRAILUM_PID_FILENAME;
...
{
    std::string s = strprintf("grailum-%s", name);
