...
#include <config/grailum-config.h> /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatGrailumURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + GrailumUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatGrailumURI(info));
}
