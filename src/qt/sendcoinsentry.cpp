    ...
    platformStyle(_platformStyle)
{
    ...
    // normal grailum address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying grailum address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &GrailumAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
