...
#ifndef GRAILUM_QT_GRAILUMUNITS_H
#define GRAILUM_QT_GRAILUMUNITS_H
...
/** Grailum unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class GrailumUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit GrailumUnits(QObject *parent);

    /** Grailum units.
      @note Source: https://en.grailum.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        GXM,
...
typedef GrailumUnits::Unit GrailumUnit;

#endif // GRAILUM_QT_GRAILUMUNITS_H
