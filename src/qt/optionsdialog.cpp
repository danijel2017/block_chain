    ...
    mapper(0)
{
    ...
    ui->grailumAtStartup->setToolTip(ui->grailumAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->grailumAtStartup->setText(ui->grailumAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openGrailumConfButton->setToolTip(ui->openGrailumConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new GrailumUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->grailumAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openGrailumConfButton_clicked()
{
