...
#ifndef GRAILUM_KEYSTORE_H
#define GRAILUM_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/grailum/bips/blob/master/bip-0013.mediawiki
