...
#ifndef GRAILUM_TEST_SCRIPTNUM10_H
#define GRAILUM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Grailum Core 0.10.0, for cross-comparison.
 */
public:
