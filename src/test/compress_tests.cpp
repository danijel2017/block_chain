...
// amounts 1 .. 10000
#define NUM_MULTIPLES_1GXM 10000

// amounts 100 .. 84000000
#define NUM_MULTIPLES_50GXM 420000
...
BOOST_AUTO_TEST_CASE(compress_amounts)
{
    ...
    for (uint64_t i = 1; i <= NUM_MULTIPLES_1GXM; i++)
        BOOST_CHECK(TestEncode(i * COIN));

    for (uint64_t i = 1; i <= NUM_MULTIPLES_50GXM; i++)
